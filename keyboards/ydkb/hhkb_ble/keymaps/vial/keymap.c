    ...
    if (record->event.pressed) {
        if (IS_LAYER_ON(WIN_LAYER) || IS_LAYER_ON(MAC_LAYER)) {
            if (keycode >= KC_LCTL && keycode <= KC_RGUI) { // 按下修饰键，记录下即可
                ...
                if (held_mods) { // 当前按下的是普通按键，但此时修饰键处于按下状态
                    ...
                    MOVE_to_LAYER(2)
                    MOVE_to_LAYER(3)
                    HANDLE_DOWN_BTH(KC_H, MOD_BIT(KC_LCTL), KC_LEFT, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_J, MOD_BIT(KC_LCTL), KC_DOWN, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_K, MOD_BIT(KC_LCTL), KC_UP, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_L, MOD_BIT(KC_LCTL), KC_RIGHT, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_H, MOD_BIT(KC_LALT), KC_LEFT, MOD_BIT(KC_LCTL)) // 终端后退一个单词
                    HANDLE_DOWN_BTH(KC_L, MOD_BIT(KC_LALT), KC_RIGHT, MOD_BIT(KC_LCTL)) // 终端前进一个单词
                    HANDLE_DOWN_BTH(KC_ESC, MOD_BIT(KC_LSFT), KC_GRV, MOD_BIT(KC_LSFT))
                    HANDLE_DOWN_BTH(KC_ESC, MOD_BIT(KC_LCTL), KC_GRV, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_BSPC, MOD_BIT(KC_LSFT), KC_BSLS, MOD_BIT(KC_LSFT))
                    HANDLE_DOWN_BTH(KC_BSPC, MOD_BIT(KC_LCTL), KC_BSLS, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_E, MOD_BIT(KC_LCTL), KC_END, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_QUOT, MOD_BIT(KC_LCTL), KC_BSPC, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_SCLN, MOD_BIT(KC_LCTL), KC_RETN, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_B, MOD_BIT(KC_LCTL), KC_BSPC, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_ESC, MOD_BIT(KC_LALT), KC_GRV, MOD_BIT(KC_LALT))
                    HANDLE_DOWN_BTH(KC_U, MOD_BIT(KC_LALT), KC_PGUP, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_D, MOD_BIT(KC_LALT), KC_PGDN, MODS_NULL)
                    HANDLE_DOWN_BTH(KC_J, MOD_BIT(KC_LALT), KC_PGUP, MODS_NULL)
        ...
        if (IS_LAYER_ON(WIN_LAYER) || IS_LAYER_ON(MAC_LAYER)) {
            if (keycode >= KC_LCTL && keycode <= KC_RGUI) {
                ...
                HANDLE_UP_BTH(KC_K, MOD_BIT(KC_LCTL), KC_UP, MODS_NULL)
                HANDLE_UP_BTH(KC_L, MOD_BIT(KC_LCTL), KC_RIGHT, MODS_NULL)
                HANDLE_UP_BTH(KC_H, MOD_BIT(KC_LALT), KC_LEFT, MOD_BIT(KC_LCTL)) // 终端后退一个单词
                HANDLE_UP_BTH(KC_L, MOD_BIT(KC_LALT), KC_RIGHT, MOD_BIT(KC_LCTL)) // 终端前进一个单词
                HANDLE_UP_BTH(KC_ESC, MOD_BIT(KC_LSFT), KC_GRV, MOD_BIT(KC_LSFT))
                HANDLE_UP_BTH(KC_ESC, MOD_BIT(KC_LCTL), KC_GRV, MODS_NULL)
                HANDLE_UP_BTH(KC_BSPC, MOD_BIT(KC_LSFT), KC_BSLS, MOD_BIT(KC_LSFT))
                HANDLE_UP_BTH(KC_BSPC, MOD_BIT(KC_LCTL), KC_BSLS, MODS_NULL)
                HANDLE_UP_BTH(KC_E, MOD_BIT(KC_LCTL), KC_END, MODS_NULL)
                HANDLE_UP_BTH(KC_QUOT, MOD_BIT(KC_LCTL), KC_BSPC, MODS_NULL)
                HANDLE_UP_BTH(KC_SCLN, MOD_BIT(KC_LCTL), KC_RETN, MODS_NULL)
                HANDLE_UP_BTH(KC_B, MOD_BIT(KC_LCTL), KC_BSPC, MODS_NULL)
                HANDLE_UP_BTH(KC_ESC, MOD_BIT(KC_LALT), KC_GRV, MOD_BIT(KC_LALT))
                HANDLE_UP_BTH(KC_U, MOD_BIT(KC_LALT), KC_PGUP, MODS_NULL)
                HANDLE_UP_BTH(KC_D, MOD_BIT(KC_LALT), KC_PGDN, MODS_NULL)
                HANDLE_UP_BTH(KC_J, MOD_BIT(KC_LALT), KC_PGUP, MODS_NULL)
